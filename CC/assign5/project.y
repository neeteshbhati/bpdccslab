...
%token HEADER MAIN LB RB LCB RCB SC COMA VAR EQ PLUS MINUS MUL DIV EXP UPLUS UMINUS MOD LT GT LTE GTE NEQ LEQ LAND LOR NOT IF ELSE QUES COLN WHILE DO FOR NUM
